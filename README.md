...
e2ee_backend/
  ...
  cli.py          # register/show/revoke-*/rotate-identity-key/add-prekey/claim-prekey/create-session/show-session/group-*/create-group-session/show-group-session/sync-group-messages/sync-checkpoint/send-message/pull-messages/retry-message/ack-message/message-status/encrypt-message/decrypt-message/serve 命令行入口
tests/            # unittest 测试
```
